...
export const linkPeople: LinkPerson[] = [
  ...
  { id: 'hannah-fry', name: 'Hannah Fry', hasAccount: false, src: '/images/linkinbio/hannah-fry.jpg' },
  { id: 'jim-al-khalili', name: 'Jim Al-Khalili', hasAccount: false, src: '/images/linkinbio/jim-al-khalili.jpg' },
  { id: 'katie-bouman', name: 'Katie Bouman', hasAccount: false, src: '/images/linkinbio/katie-bouman.jpg' },
  { id: 'carlo-rovelli', name: 'Carlo Rovelli', hasAccount: false, src: '/images/linkinbio/carlo-rovelli.jpg' },
  { id: 'sabine-hossenfelder', name: 'Sabine Hossenfelder', hasAccount: false, src: '/images/linkinbio/sabine-hossenfelder.jpg' },
  { id: 'mehdi-hasan', name: 'Mehdi Hasan', hasAccount: false, src: '/images/linkinbio/mehdi-hasan.jpg' },
  { id: 'naga-munchetty', name: 'Naga Munchetty', hasAccount: false, src: '/images/linkinbio/naga-munchetty.jpg' },
  { id: 'anita-rani', name: 'Anita Rani', hasAccount: false, src: '/images/linkinbio/anita-rani.jpg' },
  ...
  { id: 'min-jin-lee', name: 'Min Jin Lee', hasAccount: false, src: '/images/linkinbio/min-jin-lee.jpg' },
  { id: 'ocean-vuong', name: 'Ocean Vuong', hasAccount: false, src: '/images/linkinbio/ocean-vuong.jpg' },
  { id: 'bill-bailey', name: 'Bill Bailey', hasAccount: false, src: '/images/linkinbio/bill-bailey.jpg' },
  { id: 'reza-aslan', name: 'Reza Aslan', hasAccount: false, src: '/images/linkinbio/reza-aslan.jpg' },
];
